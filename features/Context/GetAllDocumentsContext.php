...
class GetAllDocumentsContext extends BaseContext
{
    /**
     ...
     * @throws \Exception
     */
    public function itShouldReturnAValidGetObjectsResponse()
    {
        // Get last response, while asserting its class for debugging purposes.
        /** @var GetObjectsResponse $response */
        $response = $this->helper->getLastResponse(GetObjectsResponse::class);
     ...
     * @throws \Exception
     */
    public function itShouldExistAValidMfilesObject()
    {
        // Get last response, while asserting its class for debugging purposes.
        /** @var GetObjectsResponse $response */
        $response = $this->helper->getLastResponse(GetObjectsResponse::class);

        /** @var MFilesObject $object */
     ...
     * @throws \Exception
     */
    public function itShouldExistAValidMfilesVersionObject()
    {
        // Get last response, while asserting its class for debugging purposes.
        /** @var GetObjectsResponse $response */
        $response = $this->helper->getLastResponse(GetObjectsResponse::class);
     ...
     * @throws \Exception
     */
    public function itShouldExistAValidFilesObjects()
    {
        // Get last response, while asserting its class for debugging purposes.
        /** @var GetObjectsResponse $response */
        $response = $this->helper->getLastResponse(GetObjectsResponse::class);
     ...
     * @return MFilesObject
     */
    private function getMFilesObjectIfExist(array $objects) : MFilesObject
    {
        if (isset($objects[0])) {
            return $objects[0];
        }
